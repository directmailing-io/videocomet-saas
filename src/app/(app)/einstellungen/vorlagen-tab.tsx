...
/**
 * Vorlagen & Medien: Einstiegspunkt für Mediathek und die drei Vorlagen-
 * Bereiche, seit sie keinen eigenen Nav-Punkt mehr haben (Nav-Diät Etappe C).
 */
const ITEMS = [
  {
    href: "/mediathek",
    icon: Library,
    title: "Mediathek",
    text: "Deine hochgeladenen Videos, Bilder und Dokumente an einem Ort.",
  },
  {
    href: "/landingpages",
    icon: LayoutTemplate,
